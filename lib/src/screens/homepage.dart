                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: ListTile(
                          ...
                          title: Text(
                            "Undying Thought".toString(),
                            style: Fonts.akebono(22, Colors.white),
                          ),
                          subtitle: Text(
                            "Some ways to within",
                            style: Fonts.akebono(
                                13, Colors.white.withOpacity(0.5)),
                          ),
                          leading: CircleAvatar(
                            radius: 40,
                            backgroundImage: AssetImage(
                                "assets/images/icon.jpg"), // no matter how big it is, it won't overflow
                            child: Container(
